...
* No se asegura el correcto funcionamiento del juego en Windows ni en Lin<br>ux, al menos en las
...
*
* Para compilar el proyecto debes ejecutar el siguiente comando:
* g++ main.cpp `allegro-config --libs --static`
*
* @section eje_sec Ejecución
*
* Para ejecutarlo basta con correr el ejecutable (en el ejemplo ./a.out).
*
...
* @todo Mostrar la puntuación en la pantalla del juego
...
* ha sido eliminado (puesto a NULL)?
* @bug Solucionar problemas con los disparos. ¿Por qué en ciertas ocasiones no puede disparar más?
* CORREGIDO (Los disparos que salían fuera de la pantalla getY()<0 no se eliminaban y si desaparecian
...
* sin embargo te detecta que has pulsado más de una vez, realizando más de un disparo a la vez
*
*/
